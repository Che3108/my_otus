...
Максимальное число операций, которые можно назвать мошенническими: 400 * 0.05 = 20
Вводим допущение, что 1 мошеническую операцию алгоритм упустил (мы же говорим о прототипе). 
